#!/usr/bin/env python3
"""
TEKO - 16-STAGE ULTRA-GRADUAL CURRICULUM TRAINING (FINAL, NO FORCED JUMPS)
==========================================================================
Author: Alexandre Schleier Neves da Silva
Contact: alexandre.schleiernevesdasilva@uni-hohenheim.de

- Vision-only PPO with your current visual encoder (create_visual_encoder("simple", 256, False))
...
- IMPORTANT:
    There is **no forced advancement by max steps** anymore.
    A stage is only advanced when its rolling success rate exceeds
    the corresponding threshold (after enough episodes).
"""
...
def main():
    print("\n" + "=" * 70)
    print("🎓 TEKO - 16-STAGE ULTRA-GRADUAL CURRICULUM (FINAL, NO FORCED JUMPS)")
    print("=" * 70)
    print(f"Environments: {args.num_envs}")
    print(f"Total steps: {args.steps:,}")
    print(f"Stages: {len(STAGE_NAMES)} (ultra-gradual)")
    print(f"Advancement: stage-dependent thresholds, "
          f"min {HYPERPARAMS['min_stage_steps']:,} steps/stage, "
          f"no max-step auto-advance")
    print("=" * 70 + "\n")
    ...
    while step < args.steps:
        ...
        # ------------------------------------------------------------------
        # Curriculum advancement: ONLY when threshold is met
        # ------------------------------------------------------------------
