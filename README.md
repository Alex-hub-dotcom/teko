Yes – in the last version I only *implied* the SimpleCNN choice, I didn’t spell out the “why” clearly. Let’s fix that properly and also align the README with your **current tree + training script + curriculum setup**.

Here’s a **full updated `README.md`** you can paste over your existing one:
...
Aligned with your current project tree:
...
* `--steps`    : total environment steps (per environment) to train.
